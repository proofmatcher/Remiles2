...
class _ShipperSettingsPageState extends State<ShipperSettingsPage> {
  ...
  Future<void> _sendDeleteAccountOTP() async {
    final shipper = context.read<AuthProvider>().shipperUser;
    if (shipper?.phoneNumber == null || shipper!.phoneNumber!.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
    ...
    try {
      ...
      String phoneNumber = shipper.phoneNumber!.trim();
      if (!phoneNumber.startsWith('+')) {
        phoneNumber = '+$phoneNumber';
      }
  ...
  Future<void> _deleteAccount() async {
    ...
    final confirmed = await showDialog<bool>(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text(
          'Are you sure you want to delete your account? This action cannot be undone. All your data, loads, listings, and messages will be permanently deleted.',
        ),
        actions: [
          TextButton(
                          ...
                          children: [
                            Row(
                              children: [
                                ...
                                Expanded(
                                  child: Text(
                                    'Deleting your account will permanently remove all your data, including loads, listings, messages, and payment information. This action cannot be undone.',
                                    style: TextStyle(
                                      fontSize: 12,
